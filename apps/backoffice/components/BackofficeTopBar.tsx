...
import {
  Bell, ChevronDown, CircleHelp, Clock3, Command, Download, Home, LogOut, Menu,
  Moon, Plus, RefreshCcw, Search, Settings, Sun, User, Users, Palette, ShieldCheck,
  Box, Building2, KeyRound, Laptop, Mail
} from "lucide-react";
                  ...
                  {filtered.map(a => (
                    <li key={a.id}>
                      ...
                      >
                        ...
                        {a.kbd && (
                          <span className="rounded-md border px-1.5 py-0.5 text-[10px] text-zinc-500 dark:border-zinc-700">
                            {a.kbd}
                          </span>
                        )}
                      </button>
...
const Avatar = ({ name = "Ajithan", size = 28 }: { name?: string; size?: number }) => {
  ...
  return (
    <div
      className="grid place-items-center rounded-full bg-gradient-to-br from-fuchsia-500 to-pink-500 text-white shadow"
    ...
    <Menu className="h-6 w-6 text-zinc-700 dark:text-zinc-200" />
        ...
        <div className="ml-auto flex items-center gap-1 sm:gap-2">
          ...
          <div className="relative">
            ...
            <div
              id="rb-quick-create"
              className="hidden absolute right-0 mt-2 w-56 overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-lg dark:border-zinc-800 dark:bg-zinc-900"
            >
          ...
          <div className="relative">
            <button
              onClick={() => { document.getElementById("rb-theme-menu")?.classList.toggle("hidden"); }}
            ...
            <div
              id="rb-theme-menu"
              className="hidden absolute right-0 mt-2 w-44 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-lg dark:border-zinc-800 dark:bg-zinc-900"
            >
              {[
                ...
                <button
                  key={m.key}
                  onClick={() => { setTheme(m.key); document.getElementById("rb-theme-menu")?.classList.add("hidden"); }}
